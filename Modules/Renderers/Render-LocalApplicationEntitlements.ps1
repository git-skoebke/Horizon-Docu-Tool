# =============================================================================
# Render-LocalApplicationEntitlements — New-HtmlLocalApplicationEntitlementsSection
# Dot-sourced inside the Runspace scriptblock
# =============================================================================

function New-HtmlLocalApplicationEntitlementsSection {
    param($Entitlements)
    ...
    $rows = foreach ($e in ($Entitlements | Sort-Object PoolName, Name)) {
        ...
        $memberCell  = & $buildMemberCell $e ("lae-$rowIndex")
        $rowIndex++
    ...
    $table = New-HtmlTable -Headers @("Application Pool","Entitlement (AD Group / User)","Type","Member Count") -Rows $rows
    ...
    return New-HtmlSection -Id "local-application-entitlements" -Title "Local Application Entitlements" -Content $content
}
